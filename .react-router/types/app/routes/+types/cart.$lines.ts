...
import type { Info as Parent1 } from "./cart.js"

type Module = typeof import("../cart.$lines.js")

export type Info = {
  parents: [Parent0, Parent1],
  id: "routes/cart.$lines"
  file: "routes/cart.$lines.jsx"
  path: ":lines"
  params: {"lines": string} & { [key: string]: string | undefined }
  module: Module
