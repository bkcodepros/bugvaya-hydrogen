...
type Module = typeof import("../blogs.$blogHandle.$articleHandle.js")

export type Info = {
  parents: [Parent0],
  id: "routes/blogs.$blogHandle.$articleHandle"
  file: "routes/blogs.$blogHandle.$articleHandle.jsx"
  path: "blogs/:blogHandle/:articleHandle"
  params: {"blogHandle": string; "articleHandle": string} & { [key: string]: string | undefined }
  module: Module
