(function(_,c){typeof exports=="object"&&typeof module<"u"?c(exports,require("react")):typeof define=="function"&&define.amd?define(["exports","react"],c):(_=typeof globalThis<"u"?globalThis:_||self,c(_.hydrogenreact={},_.React))})(this,function(_,c){"use strict";function rr(e){const t=Object.create(null,{[Symbol.toStringTag]:{value:"Module"}});if(e){for(const r in e)if(r!=="default"){const n=Object.getOwnPropertyDescriptor(e,r);Object.defineProperty(t,r,n.get?n:{enumerable:!0,get:()=>e[r]})}}return t.default=e,Object.freeze(t)}const k=rr(c);/*! *****************************************************************************
  ...
  ***************************************************************************** */function Ze(e,t){var r=typeof Symbol=="function"&&e[Symbol.iterator];if(!r)return e;var n,a,i=r.call(e),s=[];try{for(;(t===void 0||t-- >0)&&!(n=i.next()).done;)s.push(n.value)}catch(o){a={error:o}}finally{try{n&&!n.done&&(r=i.return)&&r.call(i)}finally{if(a)throw a.error}}return s}var te;(function(e){e[e.NotStarted=0]="NotStarted",e[e.Running=1]="Running",e[e.Stopped=2]="Stopped"})(te||(te={}));var Ke={type:"xstate.init"};function Pe(e){return e===void 0?[]:[].concat(e)}function ne(e){return{type:"xstate.assign",assignment:e}}function Qe(e,t){return typeof(e=typeof e=="string"&&t&&t[e]?t[e]:e)=="string"?{type:e}:typeof e=="function"?{type:e.name,exec:e}:e}function Te(e){return function(t){return e===t}}function Je(e){return typeof e=="string"?{type:e}:e}function Xe(e,t){return{value:e,context:t,actions:[],changed:!1,matches:Te(e)}}function ze(e,t,r){var n=t,a=!1;return[e.filter(function(i){if(i.type==="xstate.assign"){a=!0;var s=Object.assign({},n);return typeof i.assignment=="function"?s=i.assignment(n,r):Object.keys(i.assignment).forEach(function(o){s[o]=typeof i.assignment[o]=="function"?i.assignment[o](n,r):i.assignment[o]}),n=s,!1}return!0}),n,a]}function et(e,t){t===void 0&&(t={});var r=Ze(ze(Pe(e.states[e.initial].entry).map(function(s){return Qe(s,t.actions)}),e.context,Ke),2),n=r[0],a=r[1],i={config:e,_options:t,initialState:{value:e.initial,actions:n,context:a,matches:Te(e.initial)},transition:function(s,o){var u,l,y=typeof s=="string"?{value:s,context:e.context}:s,d=y.value,g=y.context,f=Je(o),h=e.states[d];if(h.on){var S=Pe(h.on[f.type]);try{for(var T=function(U){var ce=typeof Symbol=="function"&&Symbol.iterator,Ee=ce&&U[ce],Se=0;if(Ee)return Ee.call(U);if(U&&typeof U.length=="number")return{next:function(){return U&&Se>=U.length&&(U=void 0),{value:U&&U[Se++],done:!U}}};throw new TypeError(ce?"Object is not iterable.":"Symbol.iterator is not defined.")}(S),b=T.next();!b.done;b=T.next()){var I=b.value;if(I===void 0)return Xe(d,g);var w=typeof I=="string"?{target:I}:I,v=w.target,p=w.actions,m=p===void 0?[]:p,E=w.cond,P=E===void 0?function(){return!0}:E,R=v===void 0,A=v??d,O=e.states[A];if(P(g,f)){var H=Ze(ze((R?Pe(m):[].concat(h.exit,m,O.entry).filter(function(U){return U})).map(function(U){return Qe(U,i._options.actions)}),g,f),3),D=H[0],$=H[1],ee=H[2],pe=v??d;return{value:pe,context:$,actions:D,changed:v!==d||D.length>0||ee,matches:Te(pe)}}}}catch(U){u={error:U}}finally{try{b&&!b.done&&(l=T.return)&&l.call(T)}finally{if(u)throw u.error}}}return Xe(d,g)}};return i}var tt=function(e,t){return e.actions.forEach(function(r){var n=r.exec;return n&&n(e.context,t)})};function nr(e){var t=e.initialState,r=te.NotStarted,n=new Set,a={_machine:e,send:function(i){r===te.Running&&(t=e.transition(t,i),tt(t,Je(i)),n.forEach(function(s){return s(t)}))},subscribe:function(i){return n.add(i),i(t),{unsubscribe:function(){return n.delete(i)}}},start:function(i){if(i){var s=typeof i=="object"?i:{context:e.config.context,value:i};t={value:s.value,actions:[],context:s.context,matches:Te(s.value)}}else t=e.initialState;return r=te.Running,tt(t,Ke),a},stop:function(){return r=te.Stopped,n.clear(),a},get state(){return t},get status(){return r}};return a}var ar=c.useLayoutEffect,Oe={exports:{}},Re={},De={exports:{}},Ve={};/**
 * @license React
 ...
 */var rt;function ir(){if(rt)return Ve;rt=1;var e=c;function t(d,g){return d===g&&(d!==0||1/d===1/g)||d!==d&&g!==g}var r=typeof Object.is=="function"?Object.is:t,n=e.useState,a=e.useEffect,i=e.useLayoutEffect,s=e.useDebugValue;function o(d,g){var f=g(),h=n({inst:{value:f,getSnapshot:g}}),S=h[0].inst,T=h[1];return i(function(){S.value=f,S.getSnapshot=g,u(S)&&T({inst:S})},[d,f,g]),a(function(){return u(S)&&T({inst:S}),d(function(){u(S)&&T({inst:S})})},[d]),s(f),f}function u(d){var g=d.getSnapshot;d=d.value;try{var f=g();return!r(d,f)}catch{return!0}}function l(d,g){return g()}var y=typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"?l:o;return Ve.useSyncExternalStore=e.useSyncExternalStore!==void 0?e.useSyncExternalStore:y,Ve}var nt;function or(){return nt||(nt=1,De.exports=ir()),De.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var at;function sr(){if(at)return Re;at=1;var e=c,t=or();function r(l,y){return l===y&&(l!==0||1/l===1/y)||l!==l&&y!==y}var n=typeof Object.is=="function"?Object.is:r,a=t.useSyncExternalStore,i=e.useRef,s=e.useEffect,o=e.useMemo,u=e.useDebugValue;return Re.useSyncExternalStoreWithSelector=function(l,y,d,g,f){var h=i(null);if(h.current===null){var S={hasValue:!1,value:null};h.current=S}else S=h.current;h=o(function(){function b(m){if(!I){if(I=!0,w=m,m=g(m),f!==void 0&&S.hasValue){var E=S.value;if(f(E,m))return v=E}return v=m}if(E=v,n(w,m))return E;var P=g(m);return f!==void 0&&f(E,P)?E:(w=m,v=P)}var I=!1,w,v,p=d===void 0?null:d;return[function(){return b(y())},p===null?void 0:function(){return b(p())}]},[y,d,g,f]);var T=a(l,h[0],h[1]);return s(function(){S.hasValue=!0,S.value=T},[T]),u(T),T},Re}var it;function cr(){return it||(it=1,Oe.exports=sr()),Oe.exports}var ur=cr();function lr(e){var t=k.useRef();return t.current||(t.current={v:e()}),t.current.v}var dr=function(e,t){var r=typeof Symbol=="function"&&e[Symbol.iterator];if(!r)return e;var n=r.call(e),a,i=[],s;try{for(;(t===void 0||t-- >0)&&!(a=n.next()).done;)i.push(a.value)}catch(o){s={error:o}}finally{try{a&&!a.done&&(r=n.return)&&r.call(n)}finally{if(s)throw s.error}}return i};function fr(e){return e}var hr=function(e){var t;return e.subscribe(function(r){t=r}).unsubscribe(),t};function gr(e,t){var r=c.useRef(),n=dr(lr(function(){var o=[],u=nr(et(e.config,t||e._options)),l=u.send;return u.send=function(y){if(u.status===te.NotStarted){o.push(y);return}l(y),r.current=u.state},[u,o]}),2),a=n[0],i=n[1];ar(function(){t&&(a._machine._options=t)});var s=mr(a);return c.useEffect(function(){return a.start(r.current),i.forEach(a.send),r.current=a.state,function(){a.stop()}},[]),s}var yr=function(e,t){return t.changed===!1};function mr(e){var t=c.useCallback(function(){return hr(e)},[e]),r=c.useCallback(function(a){var i=e.subscribe(a).unsubscribe;return i},[e]),n=ur.useSyncExternalStoreWithSelector(r,t,t,fr,yr);return[n,e.send,e]}function Q(e){if(!e){const t=`flattenConnection(): needs a 'connection' to flatten, but received '${e??""}' instead.`;return console.error(t+" Returning an empty array"),[]}return"nodes"in e?e.nodes:"edges"in e&&Array.isArray(e.edges)?e.edges.map(t=>{if(!(t!=null&&t.node))throw new Error("flattenConnection(): Connection edges must contain nodes");return t.node}):[]}const pr=e=>`
...
`).flatMap((s,o)=>{const u=`${r}-${s}-${o}`,l=c.createElement(a,{key:u,node:{type:"text",italic:t.italic,bold:t.bold,value:s}});return o===0?l:[c.createElement("br",{key:`${u}-br`}),l]});return i.length>1?c.createElement(c.Fragment,{key:r},i):i[0]}case"link":return c.createElement(a,{key:r,node:{type:"link",url:t.url,title:t.title,target:t.target,children:n}});case"list":return c.createElement(a,{key:r,node:{type:"list",listType:t.listType,children:n}});case"list-item":return c.createElement(a,{key:r,node:{type:"list-item",children:n}})}}function me(e,t=[]){switch(e.type){case"root":e.children.forEach(r=>me(r,t));break;case"heading":case"paragraph":e.children.forEach(r=>me(r,t)),t.push(" ");break;case"text":t.push(e.value||"");break;case"link":e.children.forEach(r=>me(r,t));break;case"list":e.children.forEach(r=>{r.children&&r.children.forEach(n=>me(n,t)),t.push(" ")});break;default:throw new Error(`Unknown node encountered ${e.type}`)}return t.join("").trim()}const Qn="https://cdn.shopify.com/shopifycloud/shop-js/v1.0/client.js";function Jn(e){return e==="headless"||e==="hydrogen"}function Xn({channel:e,variantIds:t,className:r,variantIdsAndQuantities:n,width:a,storeDomain:i}){const s=ue(),o=i||(s==null?void 0:s.storeDomain),u=Ye(Qn);let l=[],y;if(!o||o===ct.storeDomain)throw new Error(zn);if(t&&n)throw new Error(ta);if(!t&&!n)throw new Error(Zt);if(e)if(Jn(e))y=e;else throw new Error(ra);if(t)l=t.reduce((g,f)=>{const h=F(f).id;return h&&g.push(h),g},[]);else if(n)l=n.reduce((g,f)=>{const h=F(f==null?void 0:f.id).id;return h&&g.push(`${h}:${(f==null?void 0:f.quantity)??1}`),g},[]);else throw new Error(Zt);if(l.length===0)throw new Error(ea);const d=a?{"--shop-pay-button-width":a}:void 0;return React.createElement("div",{className:r,style:d},u==="done"&&React.createElement("shop-pay-button",{...y?{channel:y}:{},"store-url":o,variants:l.join(",")}))}const zn='You must pass a "storeDomain" prop to the "ShopPayButton" component, or wrap it in a "ShopifyProvider" component.',ea='You must pass in "variantIds" in the form of ["gid://shopify/ProductVariant/1"]',Zt='You must pass in either "variantIds" or "variantIdsAndQuantities" to ShopPayButton',ta="You must provide either a variantIds or variantIdsAndQuantities prop, but not both in the ShopPayButton component",ra='Invalid channel attribution value. Must be either "headless" or "hydrogen"';function na(e){return c.useEffect(()=>{const t=new URLSearchParams(fe(e||[])),r=new URLSearchParams(window.location.search),n=new URLSearchParams({...Object.fromEntries(r),...Object.fromEntries(t)});n.size>0&&window.history.replaceState({},"",`${window.location.pathname}?${n.toString()}`)},[JSON.stringify(e)]),null}const aa=60*60*24*360*1,ia=60*30;function oa(e){const{hasUserConsent:t=!1,domain:r="",checkoutDomain:n=""}=e||{};c.useEffect(()=>{const a=Ae(document.cookie);let i=r||window.document.location.host;if(n){const o=n.split(".").reverse(),u=i.split(".").reverse(),l=[];o.forEach((y,d)=>{y===u[d]&&l.push(y)}),i=l.reverse().join(".")}/^localhost/.test(i)&&(i="");const s=i?/^\./.test(i)?i:`.${i}`:"";t?(ve(J,a[J]||Ce(),aa,s),ve(X,a[X]||Ce(),ia,s)):(ve(J,"",0,s),ve(X,"",0,s))},[e,t,r,n])}function ve(e,t,r,n){document.cookie=Ur(e,t,{maxage:r,domain:n,samesite:"Lax",path:"/"})}_.AddToCartButton=Zr,_.AnalyticsEventName=re,_.AnalyticsPageType=be,_.BuyNowButton=mn,_.CartCheckoutButton=pn,_.CartCost=Sn,_.CartLineProvider=_n,_.CartLineQuantity=Tn,_.CartLineQuantityAdjustButton=Cn,_.CartProvider=qr,_.ExternalVideo=Vt,_.IMAGE_FRAGMENT=Un,_.Image=Lt,_.MediaFile=xn,_.ModelViewer=Yt,_.Money=Ie,_.ProductPrice=jn,_.ProductProvider=Yr,_.RichText=Kn,_.SHOPIFY_S=X,_.SHOPIFY_STOREFRONT_ID_HEADER=lt,_.SHOPIFY_STOREFRONT_S_HEADER=ft,_.SHOPIFY_STOREFRONT_Y_HEADER=dt,_.SHOPIFY_Y=J,_.ShopPayButton=Xn,_.ShopifyProvider=Rr,_.ShopifySalesChannel=Tt,_.Video=Bt,_.createStorefrontClient=Pr,_.customerAccountApiCustomScalars=wn,_.decodeEncodedVariant=Ut,_.flattenConnection=Q,_.getAdjacentAndFirstAvailableVariants=Dn,_.getClientBrowserParameters=fn,_.getProductOptions=Vn,_.getShopifyCookies=Ae,_.isOptionValueCombinationInEncodedVariant=qe,_.mapSelectedProductOptionToObject=fe,_.parseGid=F,_.parseMetafield=Fn,_.sendShopifyAnalytics=un,_.storefrontApiCustomScalars=An,_.useCart=ie,_.useCartLine=Fe,_.useLoadScript=Ye,_.useMoney=Ot,_.useProduct=pt,_.useSelectedOptionInUrlParam=na,_.useShop=ue,_.useShopifyCookies=oa,Object.defineProperty(_,Symbol.toStringTag,{value:"Module"})});
